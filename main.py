...
def main_program():
    global key_state_left, key_state_right, key_state_down, current_selection,BotType
        ...
        if current_selection == 1:
            ...
            if lang=='cn':
                if BotType == "Dog":
                    ...
                    os.system('python3 app/app_TwoCar_cn.py')
            else:
                if BotType == "Dog":
                    os.system('python3 app/app_dogzilla.py')
                elif BotType == "Car":
                    os.system('python3 app/app_TwoCar.py')
